...
> | Issue | Subject | State |
> |---|---|---|
> | [#19](https://github.com/tuna-os/bootc-installer-asahi/issues/19) | D1 cannot format the root it runs from | **decided + implemented** ([ADR 0001](https://github.com/tuna-os/bootc-installer-asahi/blob/main/docs/adr/0001-bootstrap-partition-layout.md)); real-fisherman run still open (#26) |
