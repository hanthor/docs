...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    stats: [
      ...
      {label: 'Upstream sync', value: 'Daily'},
    ],
    features: [
  ...
  },
  {
    ...
    name: 'Ghostty',
    status: 'stable',
    tagline: 'The upstream terminal, republished on the TunaOS remote and rebuilt daily.',
    lede:
      'Ghostty is a fast, feature-rich terminal by Mitchell Hashimoto — GPU rendering, the Kitty graphics protocol, and a native GTK4 app on Linux. TunaOS carries it on the Flatpak remote as a convenience: the stock upstream terminal with no TunaOS patches, rebuilt every day from ghostty-org/ghostty:main.',
    accent: '#5b21b6',
    accent2: '#a78bfa',
    ...
    features: [
      ...
      {emoji: '🔄', title: 'Tracks upstream', text: 'CI resolves the head of ghostty-org/ghostty:main daily and builds with that commit\'s own manifest.'},
    ],
    install: [
